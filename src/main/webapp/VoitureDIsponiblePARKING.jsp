            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-white mb-2">Les Voiture Disponibles</h1>
                        <p class="lead fw-normal text-white-50 mb-4">Retrouver tous les voitures Disponibles dans Parking ici !!</p>
                ...
                <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="img/parking.jpg" alt="..." /></div>
            </div>
        </div>
    </header>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <div class="text-center">
                        <h2 class="fw-bolder">Les Voitures Disponibles a la Location</h2>
                    </div>
                </div>
            </div>
