...
<div class="container error-container">
    ...
    <p><strong>Message :</strong> <span id="errorMessage">Page non trouvée.</span></p>

    <h4>Que faire maintenant ?</h4>
    <ul>
        <li><a href="dashboard.jsp">Retourner au Tableau de Bord</a></li>
        <li><a href="#" onclick="window.history.back();">Revenir à la page précédente</a></li>
        <li><a href="contact.jsp">Contacter le Support</a></li>
    </ul>
</div>
