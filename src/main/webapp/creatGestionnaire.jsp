...
<head>
    ...
    <title>Ajouter un Gestionnaire - Bool's Agence</title>
    <!-- Favicon-->
...
<main class="flex-shrink-0">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="RecuperUserServlet">Bool's Agence</a>
            ...
            <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
                <div class="text-center mb-5">
                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-person-plus"></i></div>
                        <h1 class="fw-bolder">AJOUTER UN GESTIONNAIRE</h1>
                    <p class="lead fw-normal text-muted mb-0">Saisissez les Informations ici !</p>
                </div>
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        <form action="CreatGestionnaireServlet" method="get">
                            <!-- password input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="password" data-sb-validations="required" />
                                <label>Mot de passe *</label>
                                <div class="invalid-feedback" data-sb-feedback="password:required">Le mot de passe est obligatoire!</div>
                            </div>
                            <!--nom input-->
                            <div class="form-floating mb-3">
                            ...
                            <!-- Role input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="role" data-sb-validations="required" value="gestionnaire" readonly/>
                                <label>Role *</label>
                                <div class="invalid-feedback" data-sb-feedback="role:required">Le role du gestionnaire est obligatoire!</div>
                            </div>
                            <!-- Submit button-->
