            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-4 fw-bold text-white mb-2">INFO de la Voitures !</h1>
                        <p class="lead fw-normal text-white-50 mb-4">Glissez pour decouvrir les infos de la <strong>VOITURE</strong> recherches !</p>
                    </div>
                </div>
    ...
    <section class="py-5">
        <div class="container px-5 my-5">
            <div class="text-center section-header">
                <h2 class="fw-bold">Informations de la Voiture :</h2>
            </div>
                ...
                <c:if test="${voiture!=null}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-0">Statut de Disponibilite: <c:out value="${voiture.status}"/></p>
                            </div>
                        </div>
